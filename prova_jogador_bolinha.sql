...
--
-- Dumping data for table `jogador_bolinha`
--

LOCK TABLES `jogador_bolinha` WRITE;
/*!40000 ALTER TABLE `jogador_bolinha` DISABLE KEYS */;
/*!40000 ALTER TABLE `jogador_bolinha` ENABLE KEYS */;
UNLOCK TABLES;
